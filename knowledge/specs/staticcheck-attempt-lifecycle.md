...
Карточка: `knowledge/cards/CARD-0119-staticcheck-attempt-lifecycle.md`.
Реализация должна оставить рабочий commit с изменением только
...
ГОТОВО-КОГДА: команда go run honnef.co/go/tools/cmd/staticcheck@v0.7.0 -checks 'SA*,U1000' ./internal/worker
