...
Добавить `migrations/026_task_provenance.sql` с тремя nullable-колонками в
`tasks`:
...
1. Добавить миграцию 026, ограничения и индексы; проверить открытие как новой,
...
остановить Pilot и вернуть предыдущий бинарник, не удаляя migration 026.
