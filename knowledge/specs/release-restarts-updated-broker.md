...
restart без преждевременной остановки driver. Целевой Go-тест restart —
обязательная машинная граница готовности: после реализации он завершается
нулевым кодом и не может быть заменён общим успешным прогоном.
