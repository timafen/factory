...
- Status: In progress — Factory готов; staging OAuth/callback заблокирован
  зависимостью [`tarser-operations#24`](https://github.com/timafen/tarser-operations/issues/24).
- Branch: `factory/480fc66f-1d6-3297cbcd-84b`.
- Head commit: `f0a327e` — экран, API и точный seller bridge.
