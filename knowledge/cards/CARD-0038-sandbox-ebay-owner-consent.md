...
- Status: Implemented — восстановлено на чистом `main`, целевые проверки зелёные.
- Branch: `factory/bcedfd19-d4b-3bdf72cf-d7f`.
- Head commit: `dedd492` — полный проверяемый путь согласия eBay.
...
- Evidence: `go test ./internal/controlplane` и целевой Vitest 69/69 — успешно;
  ...
  полный Vitest: 3 прежних сбоя `Dialog.test.tsx`, вне файлов этой поставки.
