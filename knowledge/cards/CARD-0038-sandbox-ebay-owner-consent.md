...
- Status: Implemented — полный контур реализован на свежем `origin/main`.
- Branch: `factory/ec5e0a22-bc4-77e1d145-7ed`.
- Head commit: `0446676` — полный проверяемый путь согласия eBay.
...
- Evidence: `go test ./...`, полный `npm test`, TypeScript, web build, lint и
  проверки запрета buyer/prod в `ops/fx` — успешно.
