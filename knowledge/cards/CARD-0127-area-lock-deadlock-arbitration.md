...
Implementation commit: 81b2c18ed4249cff16dcf3b61d1dd264e98fa4c6 — арбитр разводит живые работы с пересекающимися областями
...
`pilot/pilot.py` и `pilot/test_pilot.py`. Арбитр строит общий снимок, выбирает
одного владельца полной пересекающейся области и устраняет взаимное ожидание;
7 целевых сценариев и компиляция Python прошли.
