...
Branch: factory/bf117f2b-9e7-7b3dcf3e-630
...
После машинного возврата в `CARD-0112.md` добавлена требуемая стабильная строка
`Implementation commit` с полным SHA кодового коммита этой миграции. Повторно
подтверждены 4 теста утилиты, 5 тестов резервирования и пустой dry-run.
