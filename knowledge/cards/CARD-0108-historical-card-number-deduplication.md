...
Branch: factory/5e3f0f09-6d7-7e378782-f95
Implementation commit: c7edbbf965c3e480ef053c044cc15ad4508d5f55 — утилита и тесты одноразового разведения карточек.
What changed: добавлены dry-run/`--apply`, детерминированное переименование неканонических карточек и обновление точных ссылок.
Evidence: целевые проверки миграции — OK (4 теста); резервирование Пилота — OK (5 тестов); повторный dry-run и проверка дублей — чистые.
