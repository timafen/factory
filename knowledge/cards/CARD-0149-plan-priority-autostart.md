...
- Implementation commit: c7edbbf965c3e480ef053c044cc15ad4508d5f55 — карточки без slug включены в одноразовое разведение дублей.
...
ветки: он включает карточки без slug в проверяемое одноразовое разведение
дублей. Это устраняет ошибку машинной проверки, вызванную SHA из другой ветки.
