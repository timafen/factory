...
- Branch: `factory/a6f4c0db-e20-6f7ff1dc-5d9`.
- Implementation commit: `aeecda91d609b336d9493d7271451370a357e7e4` — recovery загружает старые ID вне первой страницы, а продолжение имеет атомарный ключ.
- What changed: после рестарта Pilot точечно читает все сохранённые terminal ID,
  включая скрытые за первой сотней; одинаковый handoff двух процессов создаётся ровно один раз.
- Evidence: `python3 -m unittest pilot.test_pilot.AdaptivePollingTests` — 21 OK;
