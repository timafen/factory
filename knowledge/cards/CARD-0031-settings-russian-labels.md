...
Branch: `factory/2d97cb82-8bd-5f55af60-969`.
Head commit: `788d8da`.
...
Два утверждённых коммита экрана «Настройки» перенесены на чистую ветку от актуального `main`; посторонние изменения старой ветки не переносились. `npx tsc -p tsconfig.app.json --noEmit`, `npx vitest run src/Settings.test.tsx` (4/4), `npx playwright test -g 'edits pilot settings from the Settings screen'` (1/1) и `npm run build` прошли успешно.
