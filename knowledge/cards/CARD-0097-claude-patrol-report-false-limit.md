Implementation commit: 41197c13f0b57869132a143dee8f91bb0c0899b8 — определён безопасный контракт реализации: слова в отчёте патруля не могут блокировать всю подписку Claude.
