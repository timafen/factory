...
После ручного APPROVE основной поставки поле `Head commit` обновлено до
фактически проверенной ревизии `1bbaa46`; границы отдельного lint-долга не
менялись.
...
в CARD-0036 и CARD-0037 и намеренно не образует плавающую самоссылку; границы
отдельного lint-долга не менялись.
