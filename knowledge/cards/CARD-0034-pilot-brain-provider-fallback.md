...
- Status: BLOCKED: целевая проверка зелёная; повторный полный Verify ждёт
  отдельного исправления общих UI-проверок в `origin/main`.
- Branch: `factory/eb0c31f1-c39-58f5ce71-35b`.
- Head commit: `877240d` (состояние до этой записи о зависимости).
...
- Next action: дождаться отдельной pipeline-задачи
  `f39669c8-84ab-436f-9794-110cc1206a1b` в `origin/main`, перебазировать ветку
  и повторить полный Verify.
