...
- Evidence: `AdminQuestionRoutingTests` — 11/11 PASS; HTTP и capacity-регрессии — PASS; `go test ./...` и `go build ./...` — PASS.
...
Полный `go test ./...` после перебазирования на свежий `origin/main` — PASS.
