...
- Implementation commit: bce06d37983ac2906dface0dac48afd71e5a23b6 — патруль ждёт потерянный переход 450 секунд, а недельная цель получает вердикт только при выборке от пяти работ.
