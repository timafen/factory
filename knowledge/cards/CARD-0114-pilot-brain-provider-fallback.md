...
Implementation commit: 1a02b134c2c9bde216df46201b3a17b19a436a9a — одноразово разведены исторические дубли номеров карточек.
...
- Для перенесённой карточки зафиксирована обязательная стабильная ссылка на
  кодовый коммит одноразового разведения исторических дублей номеров.
- `python3 -m unittest scripts.test_renumber_historical_cards` → OK (4
  теста); строка ссылается на коммит, меняющий скрипт и тест.
