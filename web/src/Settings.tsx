...
function SettingsEditor({initial,refresh}:{initial:Awaited<ReturnType<typeof api.pilotSettings>>;refresh:()=>void}) {
  ...
  return <div className="page settings-page">
    ...
    {settings._note !== undefined && <SettingsSection title="Configuration note"><label className="field settings-full"><textarea value={settings._note} onChange={(event)=>set("_note",event.target.value)} rows={3}/></label></SettingsSection>}
