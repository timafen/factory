...
try {
  const context = await browser.newContext({ viewport: { width: target.viewport_width, height: target.viewport_height }, ...(host === "factory.timafen.com" && username !== undefined ? { httpCredentials: { username, password, origin: "https://factory.timafen.com" } } : {}) });
