...
`
	...
	if capture.URL != AllowedOrigin+"/orders" || !strings.Contains(argumentText, "--proxy-server=http://127.0.0.1:") || !strings.Contains(argumentText, "--disable-quic") || strings.Contains(argumentText, "--no-sandbox") {
