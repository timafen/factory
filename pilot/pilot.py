        ...
        try:
            ...
            if verdict and verdict.get("нужен_владелец"):
                ...
                rec = write_question(
                    ...
                    [], recent_stage_text(tasks, base), work_id=work_id,
                )
                rec["owner_only"] = True
...
def record_new_works(conf, tasks, max_age_min=180):
    ...
    for _key, (n, _at, base, work_id) in first.items():
        ...
        if not origin and str(task.get("request_key") or "").startswith("automation:"):
        ...
        note_work(base, origin,
                  ...
                  skipped,
                  skipped_reason if skipped else "", work_id=work_id)
        if skipped:
